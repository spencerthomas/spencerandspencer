...
var Accordion = /*#__PURE__*/React.forwardRef(function Accordion(_ref, forwardedRef) {
  var children = _ref.children,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["children", "defaultIndex", "index", "onChange", "readOnly", "collapsible", "multiple"]);
    ...
    switch (true) {
      ...
      case defaultIndex != null:
        ...
        if (multiple) {
          ...
          return Array.isArray(defaultIndex) ? (_defaultIndex$ = defaultIndex[0]) !== null && _defaultIndex$ !== void 0 ? _defaultIndex$ : 0 : defaultIndex;
        }
      ...
      openPanels = _useState[0],
      setOpenPanels = _useState[1];
...

{
  ...
  Accordion.propTypes = {
    ...
    multiple: function multiple(props, name, compName, location, propName) {
      ...
      } else if (props[name] != null && !utils.isBoolean(props[name])) {
...
var AccordionItem = /*#__PURE__*/utils.forwardRefWithAs(function AccordionItem(_ref2, forwardedRef) {
  var _ref2$as = _ref2.as,
      ...
      props = _objectWithoutPropertiesLoose(_ref2, ["as", "children", "disabled"]);
  ...
  var itemId = utils.makeId(accordionId, index);
  var panelId = utils.makeId("panel", itemId);
  var buttonId = utils.makeId("button", itemId);
...
var AccordionButton = /*#__PURE__*/utils.forwardRefWithAs(function AccordionButton(_ref3, forwardedRef) {
  var _ref3$as = _ref3.as,
      ...
      props = _objectWithoutPropertiesLoose(_ref3, ["as", "children", "onClick", "onKeyDown", "onMouseDown", "onPointerDown", "tabIndex"]);
  ...
  return React__default.createElement(Comp // Each accordion header `button` is wrapped in an element with role
...
var AccordionPanel = /*#__PURE__*/utils.forwardRefWithAs(function AccordionPanel(_ref4, forwardedRef) {
  var _ref4$as = _ref4.as,
      ...
      props = _objectWithoutPropertiesLoose(_ref4, ["as", "children"]);
  ...
  return React__default.createElement(Comp, Object.assign({
    hidden: state !== exports.AccordionStates.Open,
